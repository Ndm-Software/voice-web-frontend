...
export default function LandingPage() {
  ...
  // Sayfa kaydırıldığında menü arka planını şeffaftan doluya geçirmek için
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#1A1A1A] font-sans text-gray-900 dark:text-[#F8FAFC] selection:bg-[#00BBA7]/30 transition-colors duration-500">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight mb-6 text-gray-900 dark:text-white leading-tight">
            Hayatınızı <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0f4c3a] to-teal-500 dark:from-[#00BBA7] dark:to-teal-300">Sesinizle</span> Yönetin
          </h1>
      ...
      <section id="ozellikler" className="py-24 bg-white dark:bg-[#1E1E1E] transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold mb-4">Sınırları Kaldıran Özellikler</h2>
            <p className="text-gray-600 dark:text-gray-400">Voia, sıradan bir takvim uygulaması değil. O, sizi dinleyen ve anlayan proaktif bir yol arkadaşıdır.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 dark:bg-[#27272A] p-8 rounded-3xl border border-gray-100 dark:border-white/5 hover:border-teal-200 dark:hover:border-[#00BBA7]/30 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3">Akıllı Hatırlatıcılar</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                "Yarın sabah 9'da toplantım var" deyin ve gerisini Voia'ya bırakın. Karmaşık formlar doldurmanıza gerek yok.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-[#27272A] p-8 rounded-3xl border border-gray-100 dark:border-white/5 hover:border-teal-200 dark:hover:border-[#00BBA7]/30 transition-all duration-300 group">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                İster bilgisayarınızdan, ister telefonunuzdan. Bulut tabanlı mimarisiyle Voia her zaman yanınızda.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* 4. NASIL ÇALIŞIR? (HOW IT WORKS) */}
      <section id="nasil-calisir" className="py-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-3xl font-bold mb-4">Sadece Konuşmanız Yeterli</h2>
            <p className="text-gray-600 dark:text-gray-400">Klavye ve fareyi unutun. Voia, doğal dili işleyerek en karmaşık takvim yönetimlerini bile saniyeler içinde halleder.</p>
          </div>

          <div className="flex flex-col md:flex-row justify-center items-center gap-12 relative">
            {/* Arka plan bağlayıcı çizgi (Sadece masaüstü) */}
            ...
            <div className="flex flex-col items-center text-center max-w-xs relative z-10">
              ...
              <h4 className="text-lg font-bold mb-2">Düğmeye Basın</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Asistanınızı uyandırın ve aklınızdakini söylemeye başlayın.</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center max-w-xs relative z-10">
              ...
              <h4 className="text-lg font-bold mb-2">Voia Çözümlesin</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Yapay zeka sesinizi metne döker ve niyetinizi, tarihleri anlar.</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center max-w-xs relative z-10">
              ...
              <h4 className="text-lg font-bold mb-2">Planınız Hazır</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Hatırlatıcınız otomatik olarak takviminize işlenir.</p>
            </div>
          </div>
        </div>
      </section>

      {/* 5. BOTTOM CTA (SON ÇAĞRI) */}
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <div className="bg-[#0f4c3a] dark:bg-[#1E1E1E] rounded-[2.5rem] p-12 lg:p-16 text-center relative overflow-hidden border border-transparent dark:border-white/10 shadow-2xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6 relative z-10">
              Geleceğin Asistanı ile Tanışın
            </h2>
            <p className="text-teal-100 dark:text-gray-400 text-lg mb-10 max-w-2xl mx-auto relative z-10">
              Ücretsiz hesabınızı oluşturun ve Voia'nın akıllı özelliklerini hemen bugün keşfetmeye başlayın.
            </p>
