  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          <h2 className="text-[28px] font-bold text-[#0f4c3a] dark:text-[#A78BFA] mb-1">Sessiz Saatler</h2>
      ...
      <div className="flex gap-8">
        ...
        <div className="flex-[2] bg-white dark:bg-[#3F3F46] rounded-2xl p-6 border border-gray-100 dark:border-[#52525B] shadow-sm dark:shadow-none">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center text-[#0f4c3a] dark:text-[#A78BFA] font-bold">
            ...
            <button className="text-sm font-semibold text-[#0f4c3a] dark:text-[#A78BFA] hover:underline">
              Tüm günlere uygula
            </button>
          </div>
              ...
              <div key={day} className="flex items-center justify-between p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-[#71717A]/10 transition-colors">
                <div className="flex items-center w-1/3">
                  ...
                  <div className="relative inline-flex items-center cursor-pointer mr-4">
                    <div className="w-11 h-6 bg-[#0f4c3a] dark:bg-[#A78BFA] rounded-full peer"></div>
                ...
                <div className="flex items-center gap-3 flex-1 justify-end">
                  ...
                  <div className="relative">
                    ...
                    <svg className="absolute right-2 top-1/2 -translate-y-1/2 w-4 h-4 text-teal-600 dark:text-[#A78BFA]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                  </div>
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <div className="bg-white dark:bg-[#3F3F46] rounded-2xl p-6 border border-gray-100 dark:border-[#52525B] shadow-sm dark:shadow-none">
            ...
            <div className="flex items-end gap-2 mb-3">
              <span className="text-4xl font-extrabold text-[#0f4c3a] dark:text-[#A78BFA] leading-none">21:38</span>
          ...
          {/* Akıllı Bilgi Kartı */}
          <div className="bg-[#0f4c3a] dark:bg-[#1e293b] dark:border dark:border-[#A78BFA]/30 rounded-2xl p-6 shadow-lg relative overflow-hidden text-white flex-1 min-h-[200px]">
             {/* Dekoratif Arka Plan (Sparkles) */}
            <svg className="absolute top-4 right-4 w-12 h-12 text-teal-600/30 dark:text-[#A78BFA]/20" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L15 9L22 12L15 15L12 22L9 15L2 12L9 9L12 2Z"></path></svg>
            
            <div className="flex items-center gap-2 mb-3 relative z-10">
              <svg className="w-5 h-5 text-teal-300 dark:text-[#A78BFA]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L13.5 8.5L20 10L13.5 11.5L12 18L10.5 11.5L4 10L10.5 8.5L12 2Z"></path><path d="M19 16L19.75 19.25L23 20L19.75 20.75L19 24L18.25 20.75L15 20L18.25 19.25L19 16Z"></path></svg>
            ...
            <button className="w-full bg-[#1c6953] dark:bg-[#A78BFA]/20 hover:bg-[#258268] dark:hover:bg-[#A78BFA]/30 text-white font-bold py-3 rounded-xl text-xs tracking-wider transition-colors border border-[#258268] dark:border-[#A78BFA]/40 shadow-sm relative z-10">
