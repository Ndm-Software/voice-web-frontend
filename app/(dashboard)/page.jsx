      ...
      <div className="grid grid-cols-3 gap-8">
        ...
        <div className="col-span-2">
          <div className="flex justify-between items-center mb-5">
            ...
            <button className="text-sm font-semibold text-[#0f4c3a] dark:text-[#00BBA7] hover:underline flex items-center">
              Tümünü Gör 
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white dark:bg-[#3F3F46] rounded-[16px] p-5 flex items-center shadow-sm dark:shadow-none dark:border dark:border-[#52525B] relative overflow-hidden h-[76px]">
              <div className="absolute left-6 top-5 bottom-5 w-1.5 rounded-full bg-[#0f4c3a] dark:bg-[#00BBA7]"></div>
              <div className="pl-12">
        ...
        <div className="col-span-1 flex flex-col gap-6">
          ...
          <div className="bg-white dark:bg-[#3F3F46] rounded-2xl p-6 shadow-sm dark:shadow-none dark:border dark:border-[#52525B]">
            ...
            <div className="grid grid-cols-7 gap-y-4 text-center text-[13px]">
              ...
              {/* Aktif Gün */}
              <div className="bg-[#0f4c3a] dark:bg-[#00BBA7] text-white font-bold rounded-full w-[26px] h-[26px] flex items-center justify-center mx-auto shadow-md">11</div>
              ...
              <div className="text-gray-700 dark:text-[#CBD5E1] font-bold mt-0.5 relative">
                15
                <div className="w-1 h-1 bg-[#0f4c3a] dark:bg-[#00BBA7] rounded-full absolute bottom-[-4px] left-1/2 -translate-x-1/2"></div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#0f4c3a] dark:bg-[#1e293b] dark:border dark:border-[#00BBA7]/30 rounded-[20px] p-8 text-center shadow-lg relative overflow-hidden flex-1 flex flex-col justify-center min-h-[220px]">
            <div className="w-16 h-16 bg-[#165a46] dark:bg-[#00BBA7]/20 rounded-full flex items-center justify-center mx-auto mb-5 border-4 border-[#1c6953] dark:border-[#00BBA7]/40 shadow-inner relative z-10">
              <svg className="w-6 h-6 text-white dark:text-[#00BBA7]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z"></path></svg>
            </div>
