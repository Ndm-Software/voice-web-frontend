      ...
      <div className="space-y-8">
          ...
          <div className="flex gap-10">
            ...
            <div className="flex flex-col items-center">
              <div className="relative w-32 h-32 rounded-2xl bg-gray-100 dark:bg-[#71717A]/30 border border-gray-200 dark:border-[#52525B] overflow-hidden mb-3">
                ...
                <button className="absolute bottom-2 right-2 w-8 h-8 bg-[#0f4c3a] dark:bg-[#00BBA7] text-white rounded-lg flex items-center justify-center hover:bg-[#0a3629] dark:hover:bg-[#009F8E] transition-colors shadow-md border border-white dark:border-[#3F3F46]">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                </button>
              </div>
              <button className="text-sm font-bold text-gray-800 dark:text-[#CBD5E1] hover:text-[#0f4c3a] dark:hover:text-[#00BBA7] transition-colors">Fotoğrafı Değiştir</button>
            </div>
        ...
        <div className="bg-white dark:bg-[#3F3F46] rounded-2xl p-8 border border-gray-100 dark:border-[#52525B] shadow-sm dark:shadow-none">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-3">
              <button className="flex items-center px-4 py-2.5 bg-teal-50 dark:bg-[#00BBA7]/10 border-2 border-[#0f4c3a] dark:border-[#00BBA7] text-[#0f4c3a] dark:text-[#00BBA7] rounded-xl font-bold text-sm shadow-sm transition-all">
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="flex bg-gray-50/50 dark:bg-[#0F172A]/40 p-1 rounded-xl border border-gray-200 dark:border-[#52525B]">
                ...
                <button className="flex-1 py-2 text-sm font-bold text-[#0f4c3a] dark:text-[#00BBA7] bg-teal-50 dark:bg-[#00BBA7]/10 border border-teal-100 dark:border-[#00BBA7]/30 rounded-lg shadow-sm">30 dk önce</button>
            ...
            <div>
              ...
              <div className="flex bg-gray-50/50 dark:bg-[#0F172A]/40 p-1 rounded-xl border border-gray-200 dark:border-[#52525B]">
                <button className="flex-1 py-2 text-sm font-bold text-[#0f4c3a] dark:text-[#00BBA7] bg-teal-50 dark:bg-[#00BBA7]/10 border border-teal-100 dark:border-[#00BBA7]/30 rounded-lg shadow-sm">Anında</button>
        ...
        <div className="flex items-center justify-between pt-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="flex items-center px-6 py-3 bg-[#0f4c3a] hover:bg-[#0a3629] dark:bg-[#00BBA7] dark:hover:bg-[#009F8E] text-white font-bold rounded-xl text-sm transition-colors shadow-sm">
